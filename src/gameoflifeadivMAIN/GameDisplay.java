...
public class GameDisplay extends JFrame {
    ...
    private void initComponents() {
        ...
        gb = new gameoflifeadivMAIN.LifeBkg();
    ...
    private void startStopButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_startStopButtonMousePressed
        ...
        hasStarted *= -1;
        //toggles whether or not the paintComponent updates itself with the LifeEngine (basically preventing the LifeEngine from ticking)
        gb.toggleTick();
    ...
    public void genMap(String path) {
        ...
        String file = OtherElements.fileToString(path);
        ...
        int w = OtherElements.parseInt(brokenFile[0]);
        //if it is not, then just set it as your width.
        if (gb.width < w) {
            //sets width to variable w
            gb.setGWidth(w);
        }
        ...
        for (int i = 1; i < brokenFile.length; i++) {
            if (OtherElements.parseInt(brokenFile[i]) > 0) {
                //toggles the value of LifeEngine[i][j] to 1 if there was a 1 in the file.
                gb.get().toggle((i - 1) % w, ((i - 1) / w));
            }
        }
    }
    ...
    private gameoflifeadivMAIN.LifeBkg gb;
